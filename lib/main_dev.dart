...
import 'package:velotoulouse/data/repository/bike_repository_mock.dart';
...
List<InheritedProvider> get devProviders {
  return [
    ...
    ChangeNotifierProvider<StationState>(create: (context) => StationState(stationRepository: StationRepositoryMock())),
  ];
}
